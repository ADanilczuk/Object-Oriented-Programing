...
// Przeciążanie operatora wyświetlania
...
Posilek* Sniadanie::losuj(int calkowita_ilosc,int x)
{
    ...
    if (x!=7)
    {
        cout<<"\n\tDo jadłospisu dodano: "<<this->nazwa_dania(linia);
        cout<<".\n\tZawiera: "<< ilosc_kalorii(linia)<<" kcal."<<endl;
        cout<<"\nJeśli chcesz losować ponownie wpisz 1, jeśli nie wpisz 2\t";
        cin>>x;
...
Posilek* Sniadanie::wybierz(int calkowita_ilosc)
{
    ...
    while (wybor==0)
    {
        cout<<"\n\nSugerowana ilość kalorii jaką powinno zawierać twoje śniadanie";
        cout<<" to mniej niż "<<max_kcal<<".";
        cout<<"\nKtóre danie chcesz wybrać? \n\n Wpisz numer \t";
        cin>>nr;
        linia=wszystkie[nr];

        if(this->ilosc_kalorii(linia) > max_kcal)
        {
            cout<<"\n Jesteś pewien, że chcesz wybrać danie o tak dużej ilości kalorii?";
            cout<<"Sugerowana ilość na ten posiłek to "<< max_kcal <<"kcal.\n Tak- 1\nNie- 0\n\t";
            cin>>i;
            if (i!=0&&i!=1) cout<<"Niepoprawna odpowiedź, spróbuj wybrać jeszcze raz";
            else wybor=i;
        }
        else wybor=1;
    }
...
void Sniadanie::dodaj_nowe()
{
    ...
    cout<<"Podaj nazwę swojego dania \t";
    cin.get();
    getline(cin, nazwa);
    cout<<"\nPodaj ilość kalorii \t";
    cin>>kalorie;
    ...
    if(lista_1.good() == true)
    {
        while(!lista_1.eof())
        {
            ...
            if (licznik==0&&this->ilosc_kalorii(linia)>atoi(kalorie.c_str()))
            {
...
Posilek* Drugie_sniadanie::wybierz(int calkowita_ilosc)
{
    ...
    while (wybor==0)
    {
        cout<<"\n\nSugerowana ilość kalorii jaką powinno zawierać twoje drugie śniadanie";
...
void Drugie_sniadanie::dodaj_nowe()
{
    ...
    rename("Bazy_danych/Drugie_sniadania_2.txt","Bazy danych\\Drugie_sniadania.txt");
    return;
}
...
Posilek* Obiad::wybierz(int calkowita_ilosc)
{
    ...
    while (wybor==0)
    {
        cout<<"\n\nSugerowana ilość kalorii jakie powinien zawierać twój obiad";
        cout<<" to mniej niż "<<max_kcal<<".";
        cout<<"\nKtóre danie chcesz wybrać? \n\n Wpisz numer \t";
        cin>>nr;
        linia=wszystkie[nr];
...
void Obiad::dodaj_nowe()
{
    ...
    rename("Bazy_danych/Obiady_2.txt","Bazy danych\\Obiady.txt");
    return;
}
...
Posilek* Przekaska::wybierz(int calkowita_ilosc)
{
    ...
    while (wybor==0)
    {
        cout<<"\n\nSugerowana ilość kalorii jaką powinna zawierać twoja przekąska";
        cout<<" to mniej niż "<<max_kcal<<".";
        cout<<"\nKtóre danie chcesz wybrać? \n\n Wpisz numer \t";
        cin>>nr;
        linia=wszystkie[nr];
...
Posilek* Kolacja::wybierz(int calkowita_ilosc)
{
    ...
    while (wybor==0)
    {
        cout<<"\n\nSugerowana ilość kalorii jaką powinna zawierać twoja kolacja";
        cout<<" to mniej niż "<<max_kcal<<".";
        cout<<"\nKtóre danie chcesz wybrać? \n\n Wpisz numer \t";
        cin>>nr;
        linia=wszystkie[nr];
