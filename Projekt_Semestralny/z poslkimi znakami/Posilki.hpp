...
{
public:
    Sniadanie(): Posilek("Śniadanie","",0) {};
    Sniadanie(string b,int c): Posilek("Śniadanie",b,c){};
...
{
public:
    Drugie_sniadanie(): Posilek("Drugie śniadanie","",0) {}
    Drugie_sniadanie(string b,int c): Posilek("Drugie śniadanie",b,c){}
...
{
public:
    Przekaska(): Posilek("Przekąska","",0) {};
    Przekaska(string b,int c): Posilek("Przekąska",b,c){};
